...
public class Campanha {
    ...
    public Campanha(String cam_data_ini, String cam_data_fim, int vol_id,
    ...
    public int getVoluntario_vol_id() { return vol_id; }
    public void setVoluntario_vol_id(int vol_id) { this.vol_id = vol_id; }
