...
public class Produto {
    ...
    public Produto gravar() { return dao.gravar(this); }
    public Produto alterar() { return dao.alterar(this); }
    public boolean apagar() { return dao.apagar(this); }
    public static Produto get(int id) { return dao.get(id); }
    public static List<Produto> get(String filtro) { return dao.get(filtro); }
